...
CHROME = {
    ...
    "en": {
        ...
        "applied": "Applied - added one @import line. Undo with xout undo",
    ...
    "ja": {
        ...
        "promise": "2分後には、エージェントにルールが8本入っています。",
        "strike_hint": "xout - 二度と見たくない方に X を。",
        "complete": "セッション完了 - コンパイルしたルール:",
        "apply": "今すぐ CLAUDE.md に適用しますか？ [y/N] ",
        "applied": "適用完了 - @import を1行追加した。取り消すには xout undo",
        "targets": "ほかのツールへ差し込むには: xout enable --grant --target codex|opencode|gemini|copilot|pi|omp|gjc|kiro|agents",
    },
    "zh": {
        "cmd": "$ uvx xout --lang zh",
        "tagline": "xout - 给你再也不想看到的那个打 X。",
        "promise": "两分钟，你的智能体就有了 8 条规则。",
        "strike_hint": "xout - 给你再也不想看到的那个打 X。",
        "complete": "会话结束 - 编译出来的规则:",
        "apply": "现在就写进 CLAUDE.md 吗？ [y/N] ",
        "applied": "已应用 - 加了一行 @import。撤销: xout undo",
        "targets": "接入其他工具: xout enable --grant --target codex|opencode|gemini|copilot|pi|omp|gjc|kiro|agents",
    },
}
