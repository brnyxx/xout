// 4개 언어 × (mp4, gif) 렌더. GIF는 README용으로 1280px·15fps (사이트는 mp4).
...
for (const lang of langs) {
  ...
  execSync(`npx remotion render src/index.ts ${id} out/how-it-works.${lang}.gif --overwrite --codec=gif --every-nth-frame=2 --scale=0.666667`, {stdio: 'inherit'});
}
